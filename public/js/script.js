...
var apiNightsky = document.getElementById('blackbar');

window.addEventListener('scroll', function () {
    headerBg.style.opacity = 1 - +window.pageYOffset / 550 + ''
    headerBg.style.backgroundPositionY = - +window.pageYOffset/2+'px'

    apiNightsky.style.opacity = 1 - +(window.pageYOffset - 966) / 550 + ''
    apiNightsky.style.backgroundPositionY = - +window.pageYOffset/2+'px'
})
